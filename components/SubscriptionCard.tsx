          ...
          <View className="sub-details">
            ...
            <View className="sub-row">
              <View className="sub-label-copy">
                ...
                <Text className="sub-value" numberOfLines={1}
                  ellipsizeMode='tail'>{renewalDate ? formatSubscriptionDateTime(renewalDate) : fallback}</Text>
              </View>
            </View>
            <View className="sub-row">
              <View className="sub-label-copy">
                ...
                <Text className="sub-value" numberOfLines={1}
                  ellipsizeMode='tail'>{status ? formatStatusLabel(status) : fallback}</Text>
              </View>
            </View>
          </View>
        </View>
